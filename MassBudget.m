...
%Burn V3 (Inclination):
initial_Mass_3 = calc_IniMass(Isp_ini, dry_mass, deltaV_Incl, g_0_earth);

% Burn V2 (Hohmann 2):
initial_Mass_2 = calc_IniMass(Isp_ini, initial_Mass_3,deltaV2, g_0_earth);

%Burn V1 (Hohmann 1):
initial_Mass_1 = calc_IniMass(Isp_ini, initial_Mass_2, deltaV1,g_0_earth);
...
wet_mass = initial_Mass_1;
prop_mass = sum(PropellantUsed);
